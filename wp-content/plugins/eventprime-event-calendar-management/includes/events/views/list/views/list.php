...
<?php foreach ( $args->events->posts as $event ) {
    $is_event_expired = check_event_has_expired($event);
    $options = array();
    ...
    <div class="ep-box-col-12">
        <div class="ep-event-list-item ep-bg-white ep-border ep-rounded ep-mb-4 ep-text-small <?php if ($is_event_expired) echo 'ep-event-expired' ?>">
