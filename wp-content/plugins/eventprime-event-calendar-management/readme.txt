...
* Option to create multiple ticket types and categories for your events with in-built tickets creation module.
* Add entrance or cover charges along with per-ticket fees.
* Build offers based on different conditions.
* You can also create informative events without bookings.
* Events directories and listings with modern search tools for your visitors.
...
* Bookings manager to manage bookings from dashboard.
* Custom user checkout fields.
* Multiple event views to fit your WordPress theme.
* Support for virtual and online events.
* Large number of fully customizable email templates.
* A variety of widgets suitable for all themes.
* Dedicated frontend user area for bookings management, wish-listing and downloading/ printing tickets.
* And much much more!

EventPrime also offers a wide selection of [free and premium extensions](https://theeventprime.com/all-extensions/) for all your requirements.
...
EventPrime is a WordPress Events Calendar plugin that supports free event bookings, paid event bookings, single day events, multi-day events, event performers, event venues and locations, event gallery, event registration, event calendar widget and a lot more. Check out our [Starter Guide](https://theeventprime.com/starter-guide/) to get up and running with this awesome event manager tool.

> If you want more out of our new WordPress events plugin, do check out its [Extensions](https://theeventprime.com/all-extensions/). We have added Live Seating, Event Sponsors, Stripe Payments, Offline Payments, Event Coupon Codes, Invoices and a lot more planned for the future!
...
* Create or Edit Events directly from the Events Calendar plugin.
...
* Additional events views include - Square Grid, Staggered Grid (Masonry), Stacked Rows and Event Sliders.
...
* Choose between option to host bookings on your own website or redirecting to an external bookings website or completely turning the bookings off.
...
= Advanced Events Settings =

Apart from regular event settings, there are multiple advanced settings to make any type of event you can imagine! These include:

* Add additional event dates apart from start and end dates.
* Create ticket categories with each category capable of including multiple ticket types.
* Set capacity or inventory for your tickets.
* Create offers for each ticket type with pre-set conditions. Incentivize your sales with automated early-bird and last minute offers among other combinations.
* Set visibility of event tickets based on different conditions.
* Choose from a list of venues and locations for your event.
* Choose from a list of performers or key persons for your event like host, speakers etc.
* Choose from a list of organizers for your event.
* Set recurrence pattern for your event from the Repeat tab. Events can be repeated based on day, week, month, year or a custom pattern.
...
* Live Seating - Create seating plans for your event and charge for tickets based on seat location. (Extension)
...
* Define age group for the events of this type.
...
* Swatch or background color for titles of child events - also visible on the frontend calendar and Wordpress calendar widget.
* Text Color for titles of child events - visible on the frontend calendar and Wordpress calendar widget.
* Age group restrictions.
* Image or Logo.

= Event Venues Manager =

* Create or edit Event Venues or Locations which can be associated with various events.
* Event Venues have their own set of customizable properties.
* Sort Event Venues based on name, slug or number of child events.
...
* Location latitude and longitude with Google Maps marker.
* Date established.
* Seating Type - Standing or Seating. [Live Seating](https://theeventprime.com/all-extensions/live-seating/) extension required for adding seat plans.
* Venue Operator or Coordinator.
* Facebook and Instagram pages of the venue.
* Images of the venue.
* Seating layout editor. Requires [Live Seating](https://theeventprime.com/all-extensions/live-seating/) Extension
...
* Role of the performer. For example, speaker, host, artist etc.
* Image of the performer.
* A separate Gallery of performer images.
...
* Contact fields like Phone, Email and Website.
* Social media pages like Facebook, Instagram, LinkedIn, Twitter etc.
...
* Image of the organizer.
* Social Media pages of the organizers, like Facebook, Instagram, LinkedIn, Twitter etc.
...
* See a table of booking containing their booking ID, username, email, and number of attendees per booking ID, booking status and payment gateway used.
...
* Manually enter attendee email addresses or load from a specific event.
* Customize email subject.
* Customize email content.

= Reports =

* Filter bookings by custom time period. Pre-sets include, Today, Yesterday, Last 7 Days, Last 30 Days, This Month and Last Month.
* Bird's eye view of the gross sales, average sales, Number of Bookings, Tickets Sold and Coupons Used.


= Settings =

Settings page allows granular EventPrime configuration. It has multiple tabs which organize related options together. These are:

= General =

This tab has all the basic settings for EventPrime.

* Hide or show past events from events directory or Wordpress calendar.
* Default WordPress calendar view.
* Select available view option for site visitors.
* Define number of events on fronted card and masonry views.
* Hide frontend event filters on events directory and WordPress calendar. 
...
= Performer Views =
Detailed settings for single performer and multi-performer frontend pages.
...
* Show/ Hide related events.
* Option to select layout of related events.
* Set maximum number of related events to display.
* Set the number of columns for the related events list.
* Show/ Hide 'Load More' button under the related events list.
* Show/ Hide past events from the related events list.
* Custom shortcode format to publish this view with all above properties passed as variables.

= Event Type Views =
Detailed settings for single Event Type and multi-event-type frontend pages.

== Event Types Directory View==
* Choose between different layout styles.
*  Select item rows and columns.
* Decide number of items to display on a single page.
* Show/ hide search button.
...
= Organizer Views =
Detailed settings for single Organizer and multi-organizer frontend pages.

== Organizers Directory View==
* Choose between different layout styles.
*  Select item rows and columns.
* Decide number of items to display on a single page.
* Show/ hide search button.
...
= User Capabilities =
Allow granular control to EventPrime dashboard area based on user roles.
...
>Functionality of this extension has been integrated into EventPrime version 3. Therefore it has been deprecated for version 3 and above.
...
[Download EventPrime Zapier Integration for EventPrime - Modern Events Calendar](https://theeventprime.com/all-extensions/zapier-integration/)
...
[Download Live Seating](https://theeventprime.com/all-extensions/live-seating/)
...
[Download Event Sponsors](https://theeventprime.com/all-extensions/event-sponsors/)
...
[Download Offline Payments](https://theeventprime.com/all-extensions/offline-payments/)
...
[Download Stripe Payments](https://theeventprime.com/all-extensions/stripe-payments/)
...
[Download Coupon Codes](https://theeventprime.com/all-extensions/coupon-codes/)
...
[Download Guest Bookings](https://theeventprime.com/all-extensions/guest-bookings/)
...
>EventPrime version 3 and above use WordPress' core comments feature instead of this extension.

= Admin Attendee Bookings =

Allows admins to create custom bookings from dashboard and add attendees manually.

[Download Admin Attendee Bookings](https://theeventprime.com/all-extensions/admin-attendee-bookings/)
...
[Download Import Export](https://theeventprime.com/all-extensions/events-import-export/)

>Functionality of this extension has been merged with Import Export Extension for EventPrime version 3. Therefore it has been deprecated for version 3 and above.
...
Check out our [Starter Guide](https://theeventprime.com/starter-guide/) to get up and running with EventPrime.

= I found a bug in EventPrime. How should I report it to you? =

That's easy. Just write to us at our [Contact page](https://theeventprime.com/support/) and our support team will get in touch with you in a matter of minutes.

= I like EventPrime, but it doesn't have some of the features I really require. How can I get them? =

We are always happy to hear your particular needs and requirements. Similar to reporting a bug, just write to us at our [Contact page](https://theeventprime.com/support/). Our support team will contact you right away.


== Screenshots ==

1. Sample Event - Frontend
2. Ticket Selection Modal - Frontend
3. Venue Details on Event Page - Frontend
4. Events Calendar view with Popover - Frontend
5. Events Listings (Grid View) - Frontend
6. Events Listings (Stacked Rows) - Frontend
7. Events Listings (Slider View) - Frontend
8. Events Listings Filter Popover - Frontend
9. Event Type page with Upcoming Events - Frontend
10. Performer page with Upcoming Events - Frontend
11. Performers Directory (Grid View) - Frontend
12. Checkout Step 1 (Attendee Fields) - Frontend
13. Checkout Step 2 (Payment) - frontend
14. Booking Confirmation Page - Frontend
15. User Area (Upcoming Events) - frontend
16. User Area (Transactions) - frontend
17. User Area (Wishlist) - frontend
18. Bookings Table - Dashboard
19. Add New Event Page - Dashboard
20. Configuring Tickets for an Event - Dashboard
21. Adding Checkout Fields to and Event - Dashboard
22. Events Table Showing Sample Events - Dashboard
23. Reports - Dashboard
24. Payment Settings - Dashboard
25. General Settings - Dashboard
26. Forms Settings - Dashboard
27. Email Settings - Dashboard
...
= 3.0.0 =
* Major new release with massive improvements. [Frontend Demo](https://theeventprime.com/navigating-the-demo/)
...
= 1.4.7 =
* Improved responsive layout for Event and Performer frontend directory pages
...
= 1.2.4 =
* Age Group will not display on Event page frontend when an Event is open for all
